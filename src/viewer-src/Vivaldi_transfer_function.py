...
class TFN_stacked_widget(QtGui.QStackedWidget):
	def __init__(self, parent, TFNcnt=1):
		super(TFN_stacked_widget, self).__init__(parent)
		self.parent = parent
	
		for elem in range(TFNcnt):
			TFN = TFN_widget(parent)
			self.insertWidget(elem, TFN)
