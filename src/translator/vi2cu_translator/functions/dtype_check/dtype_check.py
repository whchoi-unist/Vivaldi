...
func_dict['line_iter.tmp_next'] = 'float3'
...
func_dict['cut_plane_loc'] = 'float3'
...
func_dict['dot']    = 'float'
func_dict['cross']  = ''
func_dict['detach'] = 'float4'

# viewer function
func_dict['alpha_compositing'] = 'float4'
func_dict['alpha_compositing_emph'] = 'float4'
